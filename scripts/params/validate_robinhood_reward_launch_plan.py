...
def _derived(values: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "emission_only_first_capped_wall_time": "15432d2h22m24s",
...
def expected_plan() -> dict[str, Any]:
    ...
    return {
        ...
        "owner_product_decision": {
            "scope": "owner_selected_current_defaults_reward_configuration",
            "accepted_shared_budget": "Lootbox_emissions_and_Stability_rewards_share_the_1000000_RIPE_budget",
            "emission_only_runway_days_approx": "15432.099",
        ...
        "candidate_configuration": {
            "classification": "derived_owner_selected_current_launch_values",
        ...
        "runtime_facts": [
            ...
            },
            {
                ...
                "fact": "15432d2h22m24s is only the emission-only maximum from the first checkpoint; shared-budget theoretical minimum runway is zero",
            },
        ],
        "emergency_runbook": {
