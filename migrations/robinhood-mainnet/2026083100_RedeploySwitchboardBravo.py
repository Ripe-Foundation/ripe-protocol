"""Deploy PR #211's SwitchboardBravo and print its Safe activation."""
...
def migrate(migration: Migration):
    ...
    active_bravo = migration.get_contract("SwitchboardBravo", ACTIVE_BRAVO)
    ...
    log.h1("2. Deploying the PR #211 Bravo candidate")
