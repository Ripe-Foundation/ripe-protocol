...
## 9. Post-PR #188 safety deltas; full rebind pending issue #150

The new target loses the `areKeyTermsSame` selector. The immutable Base legacy source retains its
...
unlock/terms before capture. Qualification must prove isolation/block/reroute; retry is not
sufficient.

Full merged-artifact rebind and fork qualification remain issue #150 work.
