...
- Minimum-change correction: on 2026-07-24, the owner required unchanged
  ...
  be evaluated before any contract change. S3 is retained, S4 remains behind
  its necessity gate, and S5 now has an owner-selected portable action-block
  direction with the existing Base Ledger permanently retained. The S3/S4/S5
  reservations remain assertion namespaces, not independent upgrade
  authorization. H-03 through H-09 must consume the selected minimal graph from
