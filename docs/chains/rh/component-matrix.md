...
| CM-026 | `AuctionHouse` | `contracts/core/AuctionHouse.vy` | Liquidation auctions | Local liquidation auctions with the corrected safe-conversion preflight; launch-mandatory Stock Token settlement remains blocked on Track 8's minimum containment | corrected shared source integrated | Yes | Corrected source is blob-identical to current `master`; deployment binding and affected release proof remain open |
...
| CM-014 | `Deleverage.deleverageCooldown` storage initializes to `0`; no repository snapshot proves current live state; duplicated max `7,200`; Base bond terms | Keep cooldown zero; corrected SwitchboardDelta adds four bounded timelocked controls that also remain zero | MissionControl, Deleverage, BondRoom/BondBooster, Ledger, HumanResources/Contributor; BN-002/012/013/016/017/032 + TS-002 | Corrected shared source is integrated and blob-identical to current `master`; no S4 activation | Track 7 H-08 proves live zero, actual Underscore omission, and no prohibited pending actions; machine representation of the four controls remains deployment-owner work | Source/tests; high mechanics |
...
| CM-044 | Contract-local cooldown storage initializes to `0`; current live value is not in repository snapshots; max duplicated at `7,200` | Keep cooldown `0`; corrected full-payoff and dust controls also remain `0` and deferred | SwitchboardDelta/Teller; BN-012 | Corrected shared source is integrated and blob-identical to current `master`; nonzero enablement remains prohibited without separate approval | H-08 zero/omission/pending-action assertions plus deployment-owner machine representation for the four dormant controls | Source/tests; high mechanics |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Live Base parity | Reuse unchanged; upgrade Base first/together; allow time-bounded divergence; accept justified permanent exception | CM-008 is a state-bearing live Ledger whose migration is unacceptably risky; CM-014/044 now carry corrected shared source with zero controls; CM-033 S3 is retained | Accept permanent live-bytecode divergence for CM-008 while preserving one forward canonical source; preserve zero S4/control configuration; treat S3 convergence as a separate live rollout | CM-008, CM-014, CM-033, CM-044; future CM-051/052 counterparts | Protocol/deployment owner | Release freeze | CM-008 permanent exception and S3 direction approved; corrected PR #61 source integrated; activation remains gated |
| Shared clock posture | Retain/configure/disable; convert all; redesign semantic failures | Inventory maps 100 literals plus CAD-001; BN-002 is a true execution-block identity requirement, BN-012 remains dormant at zero, and BN-025 is implemented narrowly | Retain/configure first; preserve approved BN-002/025 changes and keep BN-012 dormant at zero | CM-008, CM-009, CM-011–014, CM-017, CM-029–030, CM-033, CM-038, CM-044, CM-049, CM-059 | Protocol/security owner | Block-clock specification | Analysis and BN-002/025 directions approved; BN-012 zero posture remains closed; remaining bindings open |
