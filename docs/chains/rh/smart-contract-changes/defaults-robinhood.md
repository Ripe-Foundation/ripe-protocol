...
The central nine-contract artifact checker has been retired along with
`config/contract-artifact-expectations.json`; there is no frozen identity set
to reconcile. The repository-wide ABI export check is not
