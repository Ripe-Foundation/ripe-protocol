...
**Final test evidence commit:** `c5d09f0848888750843ef6a0a637a0716522948a`
...
| `tests/vaults/test_stock_token_vault_comparison.py` | `60c000b16ed53ee7d5e935fdc37a37e8bd5b49b3d7100221784d3904f84dec6a` |
...
`ee270ab`; the 24 re-review cases use `c5d09f0`, which contains the complete
90-case suite.
...
| L-04 | Bob retains raw position after partial or total loss; governance attempts cleanup/recovery | Partial/total burn | Cleanup reflects raw state, not only live custody | User/asset remain registered | Same | 75 or 0 | Nominal/shares remain nonzero | Nominal vs live/zero | Stale vs reduced/zero | Position cannot deregister | N/A | N/A | None | Both Conform | Recovery is correctly blocked; operational cleanup unavailable | Requires zero-state policy | Pending | `test_loss_state_blocks_deregistration_and_governance_recovery` @ `c5d09f0` | **Tested:** four vault/state cases; partial recovery rejects registered funds, total reports no funds | Specify cleanup/migration path |
