...
(`GuardedErc20.vy:51-79`,
`GuardedErc20.vy:82-137`).
...
(`GuardedErc20.vy:204-218`,
`GuardedErc20.vy:233-254`,
`GuardedErc20.vy:278-292`).
...
(`stock-token-vault-decision.md, rejected unchanged`,
...
- [ ] **Outbound delivery is exact.** `transfer` either returns no data or a
  ...
  (`GuardedErc20.vy:121-135`,
  `GuardedErc20.vy:257-275`,
  `test_guarded_erc20.py:895-1014`).
