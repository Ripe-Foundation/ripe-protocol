...
This document records an earlier controller proposal. It is retained as design
history and is not the current contract specification. See [README.md](README.md).
