...
* RIPE_RESERVE_ENGINE_RH_FORK_MODE=read-only-mainnet-fork
* RIPE_RESERVE_ENGINE_RH_FORK_RPC_URL=<archive-capable Robinhood mainnet endpoint>
* RIPE_RESERVE_ENGINE_RH_FORK_BLOCK_NUMBER=<decimal child-chain block number>
* RIPE_RESERVE_ENGINE_RH_FORK_BLOCK_HASH=<0x-prefixed block hash>
* RIPE_RESERVE_ENGINE_RH_FORK_MANIFEST=<path to the accepted rh deployment manifest>
* RIPE_RESERVE_ENGINE_RH_FORK_MANIFEST_SHA256=<lowercase manifest SHA-256>
* RIPE_RESERVE_ENGINE_RH_FORK_PAYMENT_TOKEN=<accepted canonical payment-token proxy>
* RIPE_RESERVE_ENGINE_RH_FORK_PAYMENT_DECIMALS=<accepted decimal count>
* RIPE_RESERVE_ENGINE_RH_FORK_EPOCH_LENGTH=<accepted EVM-NUMBER epoch length>
...
MODE_ENV = "RIPE_RESERVE_ENGINE_RH_FORK_MODE"
MODE = "read-only-mainnet-fork"
RPC_ENV = "RIPE_RESERVE_ENGINE_RH_FORK_RPC_URL"
BLOCK_NUMBER_ENV = "RIPE_RESERVE_ENGINE_RH_FORK_BLOCK_NUMBER"
BLOCK_HASH_ENV = "RIPE_RESERVE_ENGINE_RH_FORK_BLOCK_HASH"
MANIFEST_ENV = "RIPE_RESERVE_ENGINE_RH_FORK_MANIFEST"
MANIFEST_SHA256_ENV = "RIPE_RESERVE_ENGINE_RH_FORK_MANIFEST_SHA256"
PAYMENT_TOKEN_ENV = "RIPE_RESERVE_ENGINE_RH_FORK_PAYMENT_TOKEN"
PAYMENT_DECIMALS_ENV = "RIPE_RESERVE_ENGINE_RH_FORK_PAYMENT_DECIMALS"
EPOCH_LENGTH_ENV = "RIPE_RESERVE_ENGINE_RH_FORK_EPOCH_LENGTH"
