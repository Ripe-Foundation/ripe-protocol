...
def test_vault_data_recover_funds(
    ...
    # Recover funds
    simple_erc20_vault.recoverFunds(bob, alpha_token, sender=switchboard_alpha.address)
...
def test_vault_data_asset_registration(
    ...
    assert not simple_erc20_vault.deregisterVaultAsset(alpha_token, sender=switchboard_alpha.address)
    assert simple_erc20_vault.isSupportedVaultAsset(alpha_token)
    ...
    assert simple_erc20_vault.deregisterVaultAsset(alpha_token, sender=switchboard_alpha.address)
