...
def test_basic_vault_consumer_inventory_enforces_amount_policy():
    ...
    assert backing_aware_paths == {
        ...
        ("contracts/core/AuctionHouse.vy", 1252),
        ("contracts/core/AuctionHouse.vy", 1280),
        ("contracts/core/CreditEngine.vy", 754),
        ("contracts/core/CreditEngine.vy", 774),
        ("contracts/core/CreditEngine.vy", 1283),
        ("contracts/core/CreditRedeem.vy", 191),
        ("contracts/core/Deleverage.vy", 579),
        ("contracts/core/Deleverage.vy", 971),
        ("contracts/core/Deleverage.vy", 1146),
