...
def test_green_token_blacklist_functionality(green_token, whale, bob, switchboard, governance):
    ...
    # Test blacklist
    green_token.setBlacklist(whale, True, sender=switchboard.address)
    ...
    green_token.setBlacklist(whale, False, sender=switchboard.address)
...
def test_green_token_minting_edge_cases(green_token, governance, whale, credit_engine, switchboard, alice):
...
def test_green_token_transfer_edge_cases(green_token, whale, bob, governance, switchboard):
...
def test_green_token_transfer_from_edge_cases(green_token, whale, bob, alice, governance, switchboard):
...
def test_green_token_blacklist_edge_cases(green_token, governance, switchboard, credit_engine):
    """Test blacklist edge cases"""
    # Test blacklisting self
    with boa.reverts("invalid blacklist recipient"):
        green_token.setBlacklist(green_token.address, True, sender=switchboard.address)
    
    # Test blacklisting zero address
    with boa.reverts("invalid blacklist recipient"):
        green_token.setBlacklist(ZERO_ADDRESS, True, sender=switchboard.address)
    ...
    green_token.setBlacklist(test_address, True, sender=switchboard.address)
...
def test_green_token_events(green_token, whale, bob, governance, switchboard, mock_ripe_hq):
    """Test token events"""
    # Test Transfer event
    transfer_amount = 100 * EIGHTEEN_DECIMALS
    assert green_token.transfer(bob, transfer_amount, sender=whale)
    ...
    assert green_token.setBlacklist(bob, True, sender=switchboard.address)
